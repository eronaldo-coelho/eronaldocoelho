...
### RastroAtivo
App mobile open-source para monitoramento de caminhadas, registro de rotas, passos e distâncias com histórico completo e análises de IA.  
**Tecnologias:** Flutter, GPS, Sensores do dispositivo, APIs, Inteligência Artificial  
🌐 [GitHub](https://github.com/eronaldo-coelho/RastroAtivo)

---

### Boleo
App open-source para assistir futebol, filmes, séries, canais infantis e reality shows ao vivo, de graça.  
